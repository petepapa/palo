...
---
// 默认full 撑满屏幕
<BreakoutImage src="/123.jpeg" alt="描述" layout="full" />

// contained 网站页面宽度
<BreakoutImage src="/123.jpeg" alt="描述" layout="contained" />
// wide 几乎全屏，保留圆角两侧有空隙
<BreakoutImage src="/projects/project-image-1.png" layout="wide" decorative={true} />
