...
---
// 默认：撑满屏幕
<BreakoutImage src="/123.jpeg" alt="描述" />

// 限制在容器内
<BreakoutImage src="/123.jpeg" alt="描述" fullWidth={false} />

<BreakoutImage src="/projects/project-image-1.png" fullWidth={false} decorative={true} />
