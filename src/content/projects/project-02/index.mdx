...
tags: ['Accessibility', 'AI', 'Computer Vision'] # Keywords for filtering / 用于列表过滤的标签
...
type: "video"                               # Project Layout: default, video, etc. / 作品集专属排版布局类型
...
<BreakoutImage src="/projects/project-image-3.jpg" decorative={true} />
